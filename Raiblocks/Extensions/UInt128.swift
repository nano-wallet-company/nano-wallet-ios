...
//    private static func randomLowerHalf() -> UInt128 {
//        return UInt128(UInt64.random())
//    }
//
//    private static func randomLowerHalf(_ upperBound: UInt64) -> UInt128 {
//        return UInt128(UInt64.random(upperBound))
//    }
//
//    static func random() -> UInt128 {
//        return (randomLowerHalf() << 64) &+ randomLowerHalf()
//    }
//
//    static func random(_ upperBound: UInt128) -> UInt128 {
//        if let upperBound = UInt64(exactly: upperBound) {
//            return randomLowerHalf(upperBound)
//        } else if UInt128(UInt64.max) == upperBound {
